...
CURATED: dict[str, tuple[str, str, str, str, str]] = {
    ...
    # ── Non-settlements (resolver intentionally skips) ────────────────
    "וואַרשעווער געטאָ":    ("Warsaw Ghetto",  "Q160122","ghetto",   "exclude", "sub-city historical site"),
    "לאָדזשער געטאָ":       ("Łódź Ghetto",    "Q204540","ghetto",   "exclude", "sub-city historical site"),
    "ווילנער געטאָ":        ("Vilna Ghetto",   "Q156859","ghetto",   "exclude", "sub-city historical site"),
    "ריגער געטאָ":          ("Riga Ghetto",    "Q1370115","ghetto",  "exclude", "sub-city historical site"),
    "אַמעריקע":             ("America",        "Q30",    "country",  "exclude", "USA"),
    "אָמעריקע":             ("America",        "Q30",    "country",  "exclude", "USA"),
    "אמעריקע":              ("America",        "Q30",    "country",  "exclude", "USA"),
    "אָרץ-ישראל":           ("Land of Israel", "Q23793", "region",   "exclude", "Eretz Israel"),
    "ארץ-ישראל":            ("Land of Israel", "Q23793", "region",   "exclude", "Eretz Israel"),
    "דרום-אפריקע":          ("South Africa",   "Q258",   "country",  "exclude", ""),
    "בעסאַראַביע":          ("Bessarabia",     "Q189834","region",   "exclude", "historical"),
    "רוסלאַנד און בעסאַראַביע": ("Russia and Bessarabia","","region","exclude", "compound region"),
    "פּוילישער פּראָווינץ": ("Polish province","",        "region",   "exclude", "generic"),
    "פּראָווינץ":           ("province",       "",        "region",   "exclude", "generic"),
    "פּוילן":               ("Poland",         "Q36",     "country",  "exclude", ""),
    "רוסלאַנד":             ("Russia",         "Q159",    "country",  "exclude", ""),
    "אָרגענטינע":           ("Argentina",      "Q414",    "country",  "exclude", ""),
    "אַרגענטינע":           ("Argentina",      "Q414",    "country",  "exclude", ""),
    "קאָליפֿאָרניע":        ("California",     "Q99",     "region",   "exclude", "US state"),
}
