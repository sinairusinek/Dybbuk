...
final_dir = repo_root / "data" / project / "page_final"
artifacts_dir = Path(__file__).parent / "artifacts"


def find_page(n: int) -> Path:
...
def run_pipeline(target_n: int, ref_n: int, *,
    ...
    target_xml = find_page(target_n)
    ref_xml = find_page(ref_n)
...
def main():
    ...
    p.add_argument("--page", type=int, default=7,
                   help="Page number to vocalize (default: 7)")
    p.add_argument("--ref", type=int, default=6,
                   help="Reference page providing the vocalized vocabulary (default: 6)")
    ...
    run_pipeline(args.page, args.ref,
